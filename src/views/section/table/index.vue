...
const getData = () => {
  ...
  for(let i = 1; i <= model.value.pageSize; i++) {
    ...
    let item = {
      ...
      parentId: 'parentId' + c,
      sortIndex: c,
      value: 'value base.dict.empty.content base.dict.empty.content base.dict.empty.content  base.dict.empty.content base.dict.empty.content base.dict.empty.content ' + c
    }
