  ...
  >
    <template #navigation>
      <div class="oga-navigation-item">
        <el-button class="el-material-button" link @click="addEvent">
    ...
    <oga-section
      :border-radius="30"
      :padding="30"
      heading="Element ICONS"
      description='&lt;el-icon :name="icon" :size="30"&gt;&lt;/el-icon&gt;'
    >
      <template #header>
        <el-switch
          v-model="copyType"
    ...
    <oga-section
      heading="OGA ICONS"
      description='&lt;oga-icon :name="icon" :size="30"&gt;&lt;/oga-icon&gt;'
    >
      <div class="icon-package">
        <div
          class="icon-list"
